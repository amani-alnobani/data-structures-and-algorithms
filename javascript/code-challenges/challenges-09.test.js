...
const maxInArray = (arr) => {
  // Solution code here...
  let maxValue = arr.reduce((accumelator, value) => Math.max(accumelator, value), 0);
  return maxValue;
};
...
const getCourseKeys = (obj) => {
  // Solution code here...
  let keyOfObject = Object.keys(obj);
  return keyOfObject;
};
...
const updateNumbers = (obj) => {
  // Solution code here...
  let arrayNum1 = Object.entries(obj);
  let arrayNum2 = arrayNum1.map( keyValue => keyValue.join(": "));
  return arrayNum2;
};
